...
export const tooltipNotes = {
  ...
  [Tooltip.locationName]: 'This is the name of the location you are shopping at. Rename it from the location list menu.',
  [Tooltip.latitude]: 'Coordinates for this location. Tap to open in Maps.',
